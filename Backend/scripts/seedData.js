...
// Import models
const { User, FreelancerProfile, ClientProfile, Category, Job, Service, Proposal, Chat, Message, Review, Portfolio, AIIntegration, Notification } = require("../src/models");
...
// Seed data based on frontend dummy data
