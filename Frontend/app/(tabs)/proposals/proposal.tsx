...
import { FreelancerCard, Freelancer } from "../../../components/Proposals/FreelancerCard";
...
//
const mockProposals: (Freelancer & { status: ProposalFilter })[] = [
...
function ProposalsTab() {
    ...
    const filteredProposals = useMemo(() => mockProposals.filter((f) => f.status === filter), [filter]);
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                ...
                <BookmarkModal visible={modalVisible} onClose={() => setModalVisible(false)} onAssign={handleAssign} onSave={handleSave} />
            </View>
        </SafeAreaView>
    );
}
