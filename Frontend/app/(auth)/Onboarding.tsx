...
import { View, Text, Image, TouchableOpacity, StyleSheet, SafeAreaView, ScrollView, Dimensions, Animated } from "react-native";
...
export default function OnboardingScreen() {
	...
	const renderFloatingIcon = (icon: string, color: string, style: any, animationDelay: number = 0) => {
		...
		<View key={page.id} style={styles.pageContainer}>
			...
			<View style={styles.heroSection}>
				<View style={styles.imageContainer}>
					<Image source={{ uri: page.image }} style={styles.heroImage} resizeMode="cover" />

					{/* Floating Icons */}
					{page.icon && renderFloatingIcon(page.icon, page.iconColor, styles.primaryFloatingIcon, 0)}

					{page.hasSecondaryIcon &&
						page.secondaryIcon &&
						renderFloatingIcon(page.secondaryIcon, page.secondaryIconColor || COLORS.accent, styles.secondaryFloatingIcon, 500)}

					{/* Additional floating icon for last page */}
					{page.id === 4 && renderFloatingIcon("star", COLORS.accentTertiary, styles.tertiaryFloatingIcon, 1000)}
				</View>
			</View>
				...
				<View style={styles.actionButtons}>
					{currentPage < onboardingPages.length - 1 ? (
						...
						<Animated.View style={[styles.getStartedContainer, { transform: [{ scale: bounceAnim }] }]}>
							<TouchableOpacity style={styles.getStartedButton} onPress={goToNextPage} activeOpacity={0.8}>
