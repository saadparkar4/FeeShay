              ...
              <View style={styles.roleButtons}>
                ...
                >
                  <Ionicons 
                    ...
                    size={20} 
                    color={role === 'freelancer' ? COLORS.background : COLORS.textSecondary} 
                  />
                ...
                >
                  <Ionicons 
                    name="people-outline" 
                    size={20} 
                    color={role === 'client' ? COLORS.background : COLORS.textSecondary} 
                  />
                ...
                >
                  <Ionicons 
                    ...
                    size={20} 
                    color={role === 'both' ? COLORS.background : COLORS.textSecondary} 
                  />
