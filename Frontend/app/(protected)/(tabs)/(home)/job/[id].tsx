      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
          ...
          <View style={styles.skillsContainer}>
            {jobData.skills.map((skill, index) => {
              ...
              return (
                <View
                  key={index}
                  style={[styles.skillBadge, { backgroundColor: colors.bg }]}
                >
        ...
        <View style={[styles.card, styles.budgetTypeCard]}>
          ...
          <View style={styles.budgetTypeGrid}>
            ...
            {/* Type Card */}
            <LinearGradient
              colors={[COLORS.accentTertiary + '10', COLORS.accentSecondary + '10']}
            ...
            >
              ...
              <View>
                ...
                <Text style={styles.typeValue}>
                  {jobData.budgetType === 'fixed' ? 'Fixed Price' : 'Hourly Rate'}
                </Text>
              </View>
            </LinearGradient>
          </View>
