...
export default function WelcomeScreen({ onSignIn, onSignUp, onGoogleLogin, onAppleLogin }: WelcomeScreenProps) {
	return (
				...
				<View style={styles.actionButtonsSection}>
					...
					<View style={styles.socialLoginSection}>
						...
						<View style={styles.socialButtonsContainer}>
							{/* Google Button */}
							<TouchableOpacity style={styles.socialButton} onPress={onGoogleLogin} activeOpacity={0.8}>
								<Ionicons name="logo-google" size={20} color="#4285F4" />
								<Text style={styles.socialButtonText}>Google</Text>
							</TouchableOpacity>

							{/* Apple Button */}
							<TouchableOpacity style={styles.socialButton} onPress={onAppleLogin} activeOpacity={0.8}>
