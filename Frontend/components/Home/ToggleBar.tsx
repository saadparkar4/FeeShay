    ...
    return (
        <View style={styles.toggleSection}>
            <View style={styles.toggleContainer}>
                {/* Talents tab */}
                <TouchableOpacity style={[styles.toggleBtn, tab === "talents" && styles.toggleBtnActive]} onPress={() => setTab("talents")}>
                    <Text style={[styles.toggleText, tab === "talents" && styles.toggleTextActive]}>Talents</Text>
                </TouchableOpacity>

                {/* Jobs tab */}
                <TouchableOpacity style={[styles.toggleBtn, tab === "jobs" && styles.toggleBtnActive]} onPress={() => setTab("jobs")}>
                    <Text style={[styles.toggleText, tab === "jobs" && styles.toggleTextActive]}>Jobs</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
